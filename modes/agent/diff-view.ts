...
export function formatPatch(filePath:string,before:string,after:string){
    return createTwoFilesPatch(filePath,filePath,before,after,"","",{context:3})
}

export function composedBeforeAfter(sorted:Actionlogs[]):{before:string ,after:string}{
